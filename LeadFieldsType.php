...
//    }
    ...
    {
        $this->buildFormFields($builder, $options, $options['integration_fields'], $options['mautic_fields'], 'lead', $options['limit'], $options['start'], $this->translator);
    }
    ...
    {
        return 'integration_lead_fields';
    }
